...
package com.filebox.common.kit;
...
public class ImageKit {
	 ...
	 * 删除图像
	 */
	public static RetKit deleteAvatar(String folder, String fileName) {
		String url = PathKit.getWebRootPath()+"/upload/"+folder + fileName;
		File uploadFile = new File(url);
		String teString = PathKit.getWebRootPath();
		if (uploadFile.exists()) {
			uploadFile.delete();
			return RetKit.ok("msg", "删除图片成功");
		}
		return RetKit.fail("msg", "删除图片失败");
	}
